                                ...
                                <div class="acc-body travel-form" id="travel-form">
                                    ...
                                    <div class="row">
                                        <fieldset class="fieldset1">
                                            <legend class="legend1">{{ Lang::get('core.jemaah') }} 1 ({{ Lang::get('core.primarycontact') }})</legend>
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="form-group col-md-6" id="name">
                                                        <label for="Name & Surname" class=" control-label text-left"> {{ Lang::get('core.firstname') }} <span class="asterix"> * </span></label>
                                                        <div>
                                                            <input  type='text' name='nameandsurname[]' id='nameandsurname1' @if(Auth::check()) value='{{$user['first_name']}}' @endif required class='form-control required' />
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6" id="last_name">
                                                        <label for="Name & Surname" class=" control-label text-left"> {{ Lang::get('core.lastname') }} <span class="asterix"> * </span></label>
                                                        <div>
                                                            <input  type='text' name='last_name[]' id='last_name1' @if(Auth::check()) value='{{$user['last_name']}}' @endif required class='form-control required' />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group" id="email">
                                                    <label for="Email" class=" control-label col-md-4 text-left"> {{ Lang::get('core.email') }} <span class="asterix"> * </span></label>
                                                        ...
                                                        <div>
                                                            <input  type='email' name='email[]' id='email1' @if(Auth::check()) value='{{$user['email']}}' @endif required class='form-control required' />
                                                        </div>
                                                </div>
                                ...
                                <div class="acc-body mahram-detail" id="mahram-detail">
                                    ...
                                    <div class="row">
                                        ...
                                        <fieldset class="fieldset1">
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-12">
                                                    <label for="Room Name" class=" control-label col-md-12 text-left"> {{ Lang::get('core.mahramsurname') }} <span class="asterix"> * </span></label>
                                                    ...
                                                    <div>
                                                        <select name='room[]' class="form-control mahramname" id="room1">
                                                            ...
                                                            @endif
                                                            @if($roomprice->cost_quint!=0|| $roomprice->cost_quint!=NULL)
                                                                <option value="5" @if (old('room1') == '5') selected="selected" @endif>{{ Lang::get('core.roomtype_5') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_quint }}</option>
                                                            @else
                                                                <option disabled>{{ Lang::get('core.roomtype_5') }} not available</option>
                                                            @endif
                                                            @if($roomprice->cost_sext!=0|| $roomprice->cost_sext!=NULL)
                                                                <option value="6" @if (old('room1') == '6') selected="selected" @endif>{{ Lang::get('core.roomtype_6') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_sext }}</option>
                                                            @else
                                                                <option disabled>{{ Lang::get('core.roomtype_6') }} not available</option>
                                                            @endif
                                        ...
                                        <div class="right-sidebar">
                                            ...
                                            <div class="detail-block bg-dr-blue">
                                                ...
                                                <div class="details-btn">
                                                    <button class="c-button b-40 bg-white hv-transparent" type="button" onclick="submitButton();"><span> @if(CNF_BILLPLZAPIKEY) BOOK AND PAY DEPOSIT @else BOOK AND PAY LATER @endif</span></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    function addTraveller() {
        ...
        $(".mahram-detail").append('<div id="mahram_traveller_'+num+'" class="row"><fieldset class="fieldset1"><legend class="legend1" id="mahram'+num+'"></legend><div class="col-md-12">\n' +
            ...
            '                                                            <?php if ($roomprice->cost_double!=0 || $roomprice->cost_double!=NULL){?><option value="2" @if (old("room'+num+'") == '2') selected="selected" @endif>{{ Lang::get('core.roomtype_2') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_double }}</option><?php } else {?><option disabled>{{ Lang::get('core.roomtype_2') }} not available</option><?php }?>\n' +
            '                                                            <?php if ($roomprice->cost_triple!=0 || $roomprice->cost_triple!=NULL){?><option value="3" @if (old("room'+num+'") == '3') selected="selected" @endif>{{ Lang::get('core.roomtype_3') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_triple }}</option><?php } else {?><option disabled>{{ Lang::get('core.roomtype_3') }} not available</option><?php }?>\n' +
            '                                                            <?php if ($roomprice->cost_quad!=0 || $roomprice->cost_quad!=NULL){?><option value="4" @if (old("room'+num+'") == '4') selected="selected" @endif>{{ Lang::get('core.roomtype_4') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_quad }}</option><?php } else {?><option disabled>{{ Lang::get('core.roomtype_4') }} not available</option><?php }?>\n' +
            '                                                            <?php if ($roomprice->cost_quint!=0 || $roomprice->cost_quint!=NULL){?><option value="5" @if (old("room'+num+'") == '5') selected="selected" @endif>{{ Lang::get('core.roomtype_5') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_quint }}</option><?php } else {?><option disabled>{{ Lang::get('core.roomtype_5') }} not available</option><?php }?>\n' +
            '                                                            <?php if ($roomprice->cost_sext!=0 || $roomprice->cost_sext!=NULL){?><option value="6" @if (old("room'+num+'") == '6') selected="selected" @endif>{{ Lang::get('core.roomtype_6') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_sext }}</option><?php } else {?><option disabled>{{ Lang::get('core.roomtype_6') }} not available</option><?php }?>\n' +
            '\n' +
            '                                                        </select>\n' +
            '                                                    </div>\n' +
            '                                                </div>' +
    ...
    function ageValidation(value, id) {
        const _num = id.replace(/[^0-9\.]+/g, "");
        const dob = document.getElementById(id);
        const traveller_type = document.getElementById("traveller_type"+_num).value;

        let dateSplit = value.split("-");

        let today = new Date();
        let birthDate = new Date(dateSplit[0], dateSplit[1]-1, dateSplit[2]);
        ...
        if(traveller_type == 2){
            if (age < 2 || age >16) {
                alert("Sorry but the age does not fit the traveller type. Age for children is from 2 to 16");
                dob.value = null;
            }
        }
        ...
        if(traveller_type == 3){
            if (age >= 2) {
                alert("Sorry but the age does not fit the traveller type. Age for Infant is less than 2");
                dob.value = null;
            }
        }
    }
    ...
    function changeTravellerType(value, id) {
        ...
        if(value == 2){
            ...
            const room_option_string = 
                "<option value='0'>Please Select</option>"+
                "@if ($roomprice->cost_child!=0 || $roomprice->cost_child!=NULL) <option value='7' @if (old('room"+num+"') == '7') selected @endif>{{ Lang::get('core.roomtype_7') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_child }}</option> @else <option disabled>{{ Lang::get('core.roomtype_7') }} not available</option> @endif"+
                "@if ($roomprice->cost_child_wo_bed!=0 || $roomprice->cost_child_wo_bed!=NULL) <option value='8' @if (old('room"+num+"') == '8') selected @endif>{{ Lang::get('core.roomtype_8') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_child_wo_bed }}</option> @else <option disabled>{{ Lang::get('core.roomtype_8') }} not available</option> @endif";
        ...
        if(value == 3){
            ...
            const room_option_string = 
                "@if ($roomprice->cost_child!=0 || $roomprice->cost_child!=NULL) <option value='7' @if (old('room"+num+"') == '7') selected @endif>{{ Lang::get('core.roomtype_7') }} {{CURRENCY_SYMBOLS}}{{ $roomprice->cost_child }}</option> @else <option selected value='0' disabled>{{ Lang::get('core.roomtype_7') }} not available</option> @endif";
    ...
    function validationJemaah() {
        ...
        for (var i = 1; i <= num; i++) {
            var boolean = false;
            if (document.getElementById("last_name"+i).value!==""&&document.getElementById("last_name"+i).value!==null) {
                boolean = true;
            }
            last_names.push(boolean);

        }

        var last_nameBoolean = true;
        for (var i = 0; i < last_names.length; i++) {
            last_nameBoolean = last_nameBoolean&&last_names[i];
        }
        ...
        for (var i = 1; i <= num; i++) {
            var boolean = false;
            if (document.getElementById("gender"+i).value!==""&&document.getElementById("gender"+i).value!==null) {
                console.log(document.getElementById("gender"+i).value);
                boolean = true;
            }
        ...
        return nameBoolean&&emailBoolean&&phoneBoolean&&addressBoolean&&countryIDBoolean&&nricBoolean&&genderBoolean&&last_nameBoolean;
