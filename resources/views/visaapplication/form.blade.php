...
<div class="col-md-12">
				{!! Form::hidden('applicationID', $row['applicationID']) !!}					
									  <div class="form-group  " >
										<label for="TravellersID" class=" control-label col-md-4 text-left"> {{ Lang::get('core.travellers') }}<span class="asterix"> * </span></label>
										<div class="col-md-6">
									  ...
									  <div class="form-group  " >
										<label for="CountryID" class=" control-label col-md-4 text-left"> {{ Lang::get('core.visa_application_country') }}<span class="asterix"> * </span></label>
										<div class="col-md-4">
									  ...
									  <div class="form-group  " >
										<label for="Duration" class=" control-label col-md-4 text-left"> {{ Lang::get('core.visa_duration') }} <span class="asterix"> * </span></label>
										<div class="col-md-1">
					...
					$duration2_opt = array( '1' => Lang::get('core.days') ,  '2' => Lang::get('core.weeks') ,  '3' => Lang::get('core.months') ,  '4' => Lang::get('core.years') , ); ?>
					<select name='duration2' rows='5' required  class='select2 '  > 
						...
						?></select> 
									  ...
									  <div class="form-group  " >
										<label for="Applicationdate" class=" control-label col-md-4 text-left"> {{ Lang::get('core.application_date') }} </label>
										<div class="col-md-6">
				...
				<div class="input-group m-b" style="width:150px !important;">
					...
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
									  ...
									  <div class="form-group  " >
										<label for="Processintime" class=" control-label col-md-4 text-left"> {{ Lang::get('core.processing_time') }} </label>
										<div class="col-md-1">
										  <input  type='text' name='processintime' id='processintime' value='{{ $row['processintime'] }}' 
						     class='form-control ' /> 
										 </div> 
										<label for="Processintime" class=" control-label col-md-1 text-center">{{ Lang::get('core.days') }}</label>
									  </div> 					
									  <div class="form-group  " >
										<label for="Payment" class=" control-label col-md-4 text-left"> {{ Lang::get('core.down_payment') }} </label>
										<div class="col-md-2">
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="PaymenttypeID" class=" control-label col-md-4 text-left"> {{ Lang::get('core.paymenttype') }} </label>
										<div class="col-md-4">
									  ...
									  <div class="form-group  " >
										<label for="Applicationfee" class=" control-label col-md-4 text-left"> {{ Lang::get('core.application_fee') }} </label>
										<div class="col-md-2">
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Documents" class=" control-label col-md-4 text-left"> {{ Lang::get('core.documents') }} </label>
										<div class="col-md-4">
					...
					@foreach($row['documents'] as $files)
						@if(file_exists('./uploads/files/'.CNF_OWNER.'/'.$files) && $files !='')
                            <li id="cr-<?php echo $cr;?>" class=" text-muted well well-sm no-shadow" style="margin-top: 10px;">							
							<a href="{{ url('/uploads/files/'.CNF_OWNER.'/'.$files) }}" target="_blank" >{{ $files }}</a> 
							<span class="pull-right removeMultiFiles" rel="cr-<?php echo $cr;?>" url="/uploads/files/<?php echo CNF_OWNER;?>/{{$files}}">
					...
					<input type='radio' name='status' value ='1'  @if($row['status'] == '1') checked="checked" @endif > {{ Lang::get('core.new') }} </label>
					<label class='radio radio-inline'>
					<input type='radio' name='status' value ='2'  @if($row['status'] == '2') checked="checked" @endif > {{ Lang::get('core.pending') }} </label>
					<label class='radio radio-inline'>
					<input type='radio' name='status' value ='3'  @if($row['status'] == '3') checked="checked" @endif > {{ Lang::get('core.approved') }} </label> 
                    <label class='radio radio-inline'>
					<input type='radio' name='status' value ='0'  @if($row['status'] == '0') checked="checked" @endif > {{ Lang::get('core.rejected') }} </label>
									  ...
									  <div class="form-group  visa-expiry-date" >
										<label for="Visaexpirydate" class=" control-label col-md-4 text-left"> {{ Lang::get('core.visa_expiry_date') }} </label>
										<div class="col-md-6">
				...
				<div class="input-group m-b" style="width:150px !important;">
					...
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
									  ...
									  <div class="form-group  reject-reason" >
										<label for="Rejectreason" class=" control-label col-md-4 text-left"> {{ Lang::get('core.rejected_reason') }} </label>
										<div class="col-md-6">
