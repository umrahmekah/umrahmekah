				...
				<div class="input-group m-b" style="width:150px !important;">
					...
					@foreach($row['documents'] as $files)
						...
						<li id="cr-<?php echo $cr;?>" class="">							
							<a href="{{ url('/uploads/images/'.CNF_OWNER.'/'.$files) }}" target="_blank" >{{ $files }}</a> 
							<span class="pull-right removeMultiFiles" rel="cr-<?php echo $cr;?>" url="/uploads/images/<?php echo CNF_OWNER;?>/{{$files}}">
