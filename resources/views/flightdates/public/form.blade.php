		 ...
		 {!! Form::open(array('url'=>'flightdates/savepublic', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
						<fieldset><legend> Flight Dates</legend>
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Flight Company" class=" control-label col-md-4 text-left"> Flight Company </label>
										<div class="col-md-6">
