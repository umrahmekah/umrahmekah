...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<div class="box-header-tools pull-left" >
			@if($access['is_add'] ==1)
	   		<a href="{{ url('calendartourdates/update/'.$id.'?return='.$return) }}" class="tips btn btn-default btn-xs " title="{{ Lang::get('core.btn_edit') }}" onclick="ajaxViewDetail('#calendartourdates',this.href); return false; "><i class="fa  fa-pencil fa-2x"></i></a>
			@endif 
...
@endif	
		...
		<table class="table  table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ Lang::get('core.quadroom') }}</strong></td>
						<td>{{ $row->cost_quad}} {{ SiteHelpers::formatLookUp($row->currencyID,'currencyID','1:def_currency:currencyID:symbol|currency_name') }}</td>
