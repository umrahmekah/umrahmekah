...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<div class="box-header-tools pull-left" >
			@if($access['is_add'] ==1)
	   		<a href="{{ url('calendartourdates/update/'.$id.'?return='.$return) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}" onclick="ajaxViewDetail('#calendartourdates',this.href); return false; "><i class="fa  fa-pencil fa-2x"></i></a>
			@endif 
		...
		<div class="box-header-tools pull-right " >
			...
			<a href="{{ ($prevnext['next'] != '' ? url('calendartourdates/show/'.$prevnext['next'].'?return='.$return ) : '#') }}" class="tips" onclick="ajaxViewDetail('#calendartourdates',this.href); return false; "> <i class="fa fa-arrow-right fa-lg"></i>  </a>
		...
		<div class="table-responsive" >  
			<table class="table table-striped table-bordered" >
				<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('Quad Room Cost / Traveller', (isset($fields['cost_quad']['language'])? $fields['cost_quad']['language'] : array())) }}</strong></td>
						<td>{{ $row->cost_quad}} </td>
