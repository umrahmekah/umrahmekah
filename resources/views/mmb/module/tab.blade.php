<link rel="stylesheet" href="{{ asset('mmb')}}/css/dropdown.css">
<ul class="nav nav-tabs" style="margin-bottom:10px;">
  ...
  <li @if($active == 'json') class="active" @endif >
  <a href="{{ URL::to('mmb/module/json/'.$module_name)}}"><i class="fa fa-code fa-lg text-green"></i> JSON</a></li>
