...
<div class="box box-primary">
 <div class="box-header with-border"><h4> {{ $row->module_title }} <small> : Form Editor ( Edit Form Info ) </small></h4></div>
	<div class="box-body">
	@include('mmb.module.tab',array('active'=>'form','type'=>$type))

<ul class="nav nav-tabs" style="margin-bottom:10px;">
  	<li class="active" ><a href="{{ URL::to('mmb/module/form/'.$module_name)}}">Form Configuration </a></li>
  	<li  ><a href="{{ URL::to('mmb/module/subform/'.$module_name)}}">Sub Form </a></li>
	<li ><a href="{{ URL::to('mmb/module/formdesign/'.$module_name)}}">Form Layout</a></li>
	
</ul>


 {!! Form::open(array('url'=>'mmb/module/saveform/'.$module_name, 'class'=>'form-horizontal','id'=>'fForm')) !!}
 <div class="table-responsive">
	...
	?>
		<select name="required[<?php echo $id;?>]" id="required" class="form-control input-sm" style="width:150px;" >
			...
			onclick="MmbModal('{{ URL::to('mmb/module/editform/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}','Edit Field : <?php echo $rows['field'];?>')">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo MmbHelpers::sjForm('fForm'); ?>
