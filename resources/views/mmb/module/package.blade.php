...
@section('content')
  ...
  <section class="content-header">
    <!-- Page header -->
      ...
      <ul class="breadcrumb">
    	...
    	<li><a href="{{ URL::to('mmb/module') }}"> Module </a></li>
  ...
  <div class="panel-default panel">
    ...
    <ul class="parsley-error-list">
     ...
     {!! Form::open(array('url'=>'mmb/module/dopackage', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
          <div class="col-md-6">
              <div class="header" >
          ...
          <div class="col-md-6">
           ...
           <p> Zip Package is a tool for backup  your module as installer . <br /> 
		   	You can backup current module and install the modules to other application based Mmb builder - Edition Laravel </p>
		   </p> 
