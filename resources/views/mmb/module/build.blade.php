 {!! Form::open(array('url'=>'mmb/module/dobuild/'.$module_name, 'class'=>'form-horizontal','id'=>'rebuildForm')) !!}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <a href="{{ url('mmb/module/rebuild/'.$module_id)}}" class="btn btn-danger" id="rebuild" ><i class="fa fa-repeat"></i> Rebuild All Codes </a>
      </div>
  </div> 
<hr />
    <p class="text-center " style="font-weight: bold;">
