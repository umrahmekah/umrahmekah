...
<div class="box box-primary">
 <div class="box-header with-border"><h4> {{ $row->module_title }} <small> : Form Design Editor </small></h4></div>
	...
	@include('mmb.module.tab',array('active'=>'form','type'=> 'addon'))
	...
	<ul class="nav nav-tabs" style="margin-bottom:10px;">
		...
		<li class="active" ><a href="{{ URL::to('mmb/module/formdesign/'.$module_name)}}">Form Layout</a></li>
	</ul>
	
	<p class="alert alert-success"> <strong>Tips !</strong> Drag and drop rows to re ordering lists </p>	
 {!! Form::open(array('url'=>'mmb/module/formdesign/'.$module_name,'id'=>'doReorder', 'class'=>'form-vertical','parsley-validate'=>'','novalidate'=>' ')) !!}
