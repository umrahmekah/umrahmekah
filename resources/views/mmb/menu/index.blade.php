					...
					@if(Session::get('gid') =='1')
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs" style="margin:10px 0;">
								<li @if($active == 'top') class="active" @endif ><a class="btn btn-app" href="{{ URL::to('core/menu?pos=top')}}"><i class="fa fa-desktop fa-2x"></i> {{ Lang::get('core.tab_topmenu') }} </a></li>
								<li @if($active == 'sidebar') class="active" @endif><a class="btn btn-app" href="{{ URL::to('core/menu?pos=sidebar')}}"><i class="fa fa-shield fa-2x"></i> {{ Lang::get('core.tab_sidemenu') }}</a></li>
		...
		<div class="col-sm-5">
			...
			<div class="box box-primary">
				...
				<div class="form-group  int-link" >
					<label for="ipt" class=" control-label col-md-3 text-right"> {{ Lang::get('core.t_content') }} </label>
					<div class="col-md-8">
						<select name='module' rows='5' id='module'  style="width:100%"
								class='form-control '    >

							<option value=""> {{ Lang::get('core.selectcontent') }}  </option>
				...
				@else
					<div style="display: none;"><input type="radio" name="position"  value="top" required checked="checked"  /></div>
				@endif
				<div class="form-group  " >
