	...
	<div class="box box-primary ">
		<div class="box-body"> 	
	 	{!! Form::open(array('url'=>'core/config/translation/', 'class'=>'form-vertical row')) !!}
			<div class="col-sm-9">
				<a href="{{ URL::to('core/config/addtranslation')}} " onclick="MmbModal(this.href,'{{ Lang::get('core.addnewlanguage') }}');return false;" class="btn btn-primary"><i class="fa fa-plus-circle fa-1x"></i> {{ Lang::get('core.addnewtranslation') }} </a>  
				<hr />
				<table class="table table-striped">
					...
					@foreach(SiteHelpers::langOption() as $lang)
						<tr>
							...
							<td> {{  $lang['author'] }} </td>
						  	<td>
							<a href="{{ URL::to('core/config/translation?edit='.$lang['folder'])}} " class="tips" title="Edit"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a>
                            @if($lang['folder'] !='en')
