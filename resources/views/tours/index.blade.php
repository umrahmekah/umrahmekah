                    ...
                    <tbody class="searchable">
                        ...
                        <tr data-status="{{$row->departs}}">
                            ...
                            <td width="100">
                                ...
                                @endif 
                                @if($access['is_edit'] ==1)
                                <a href="{{ url('tours/update/'.$row->tourID.'?return='.$return) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-pencil fa-2x"></i> </a> 
                                @endif 
                                @if($access['is_detail'] ==1) 
                                @if($tour_dates !=0)
                                ...
                                @endif 
                                @if($tour_dates ==0)
                                <a href="{{ url('tourdates/update?tour_id='.$row->tourID.'')}}" class="tips text-red" title="{{ Lang::get('core.adddeparturedate') }}"><i class="fa fa-plus-square fa-2x"></i> </a> 
                                @endif 
                                @endif
                            </td>
                        </tr>
