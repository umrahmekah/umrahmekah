  ...
  <div class="content"> 
	...
	<div class="box-body"> 	
		<ul class="parsley-error-list">
		 ...
		 {!! Form::open(array('url'=>'tourboundtandc/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
			...
			<div style="clear:both"></div>	
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('tourboundtandc?return='.$return) }}' " class="btn btn-warning btn-sm "><i class="fa fa-remove "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
				  </div> 
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("tourboundtandc/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
