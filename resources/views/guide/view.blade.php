...
?>
	...
	<div class="box-header with-border">
				<div class="box-header-tools pull-left" >
					...
					@if($access['is_add'] ==1)
			   		<a href="{{ url('guide/update/'.$id.'?return='.$return) }}" class="tips text-green" title="{{ Lang::get('core.btn_edit') }}"><i class="fa  fa-pencil fa-2x"></i></a>
...
<a href="{{ url('guide/notedelete/'.$gn['guideID'].'/'.$gn['guidenotesID'])}}"  class="btn btn-default btn-xs btn-flat pull-right " data-toggle="confirmation" data-title="{{Lang::get('core.rusure')}}" data-content="{{ Lang::get('core.youwanttodeletethis') }}"><i class="fa fa-trash-o text-navy"></i></a> 
					@endif
					@if($access['is_edit'] =='1')
					 <a href="{{ url('guidenotes/update/'.$gn['guidenotesID'].'/?guideID='.$id)}}"  onclick="MmbModal(this.href,'{{Lang::get('core.editnote')}}'); return false;"  class="btn btn-default btn-xs btn-flat pull-right tips" title="{{Lang::get('core.editnote')}}"><i class="fa fa-pencil text-navy"></i></a>
					@endif 
</td>
                </tr>
            @endforeach
