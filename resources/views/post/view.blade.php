					 ...
					 {!! PostHelpers::formatContent($row->note) !!}
                        ...
                        <div class="media comment_section">
                            <div class="pull-left post_comments">
								...
								<img src="{{ URL::to('uploads/users').'/'.$comm->avatar }} " border="0" height="40"  width="40" class="img-circle" />
							<?php  } else { ?> 
								<img alt="" src="http://www.gravatar.com/avatar/{{ md5($comm->email) }}" height="40"  width="40" class="img-circle" />
							<?php } ?> </a>
                            </div>
