...
<html>
  <head>
    ...
    <link href="{{ URL::asset('assets/theme/blue-ocean/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ URL::asset('assets/theme/blue-ocean/css/jquery-ui.structure.min.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ URL::asset('assets/theme/blue-ocean/css/jquery-ui.min.css')}}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link href="{{ URL::asset('assets/theme/blue-ocean/css/style.css')}}" rel="stylesheet" type="text/css"/>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12">
          ...
          @include('layouts.blue-ocean.menu')
...
<script src="{{ URL::asset('assets/theme/blue-ocean/js/jquery-2.1.4.min.js')}}"></script>
<script src="{{ URL::asset('assets/theme/blue-ocean/js/bootstrap.min.js')}}"></script>
<script src="{{ URL::asset('assets/theme/blue-ocean/js/jquery-ui.min.js')}}"></script>
<script src="{{ URL::asset('assets/theme/blue-ocean/js/idangerous.swiper.min.js')}}"></script>
<script src="{{ URL::asset('assets/theme/blue-ocean/js/jquery.viewportchecker.min.js')}}"></script>
<script src="{{ URL::asset('assets/theme/blue-ocean/js/isotope.pkgd.min.js')}}"></script>
<script src="{{ URL::asset('assets/theme/blue-ocean/js/jquery.circliful.min.js')}}"></script>
<script src="{{ URL::asset('assets/theme/blue-ocean/js/jquery.mousewheel.min.js')}}"></script>
<script src="{{ URL::asset('assets/theme/blue-ocean/js/all.js')}}"></script>
</body>
</html>