            ...
            <div class="payment__bg">
                <div class="container">
                    <div class="payment__steps">
                        ...
                        <a class="nav-link payment__step xy-center" id="passport-detail-tab" data-toggle="tab" href="#passport-detail"
                            role="tab" aria-controls="passport-detail" aria-selected="false" onclick="continueMahram();">
                            <div class="payment__icon__container">
                                <div class="payment__icon xy-center text-center"><i class="fas fa-check"></i><span>3</span></div>
                            </div>
                            <span> {{ Lang::get('core.passportdetails') }}</span>
                        </a>
                        <a class="nav-link payment__step xy-center" id="booking-summary-tab" data-toggle="tab" href="#booking-summary"
                            ...
                            <div class="payment__icon__container">
                                <div class="payment__icon xy-center text-center"><i class="fas fa-check"></i><span>4</span></div>
                            </div>
