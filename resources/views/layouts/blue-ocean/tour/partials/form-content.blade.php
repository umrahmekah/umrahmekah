                        ...
                        <div class="col mt-3">
                            ...
                            <div class="tab-content" id="booking-tab-contents">
                                <div class="tab-pane fade show active" id="jemaah-detail" role="tabpanel" aria-labelledby="jemaah-detail-tab">
                                    @include('layouts.blue-ocean.tour.partials.form-jemaah')
                                </div>
                                <div class="tab-pane fade" id="booking-detail" role="tabpanel" aria-labelledby="booking-detail-tab">
                                    @include('layouts.blue-ocean.tour.partials.form-booking')
                                </div>
                                <div class="tab-pane fade" id="passport-detail" role="tabpanel" aria-labelledby="passport-detail-tab">
                                    @include('layouts.blue-ocean.tour.partials.form-passport')
                                </div>
                                <div class="tab-pane fade" id="booking-summary" role="tabpanel" aria-labelledby="booking-summary-tab">
                                    @include('layouts.blue-ocean.tour.partials.form-summary')
                                </div>
                            </div>

                        </div>
                        <div class="layout__float col-sm-5" style="top: -190px;">
                            @include('layouts.blue-ocean.tour.partials.form-pay-summary')
...
@include('layouts.blue-ocean.tour.partials.form-scripts')