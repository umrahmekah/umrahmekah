	...
	<a href="{{ URL::to('')}}"><div class="login-logo">{{ CNF_COMNAME }}</div></a>

	<div class="login-box-body">
		<p class="login-box-msg">{{ Lang::get('core.signin') }}</p>
	...
	<span class="fa fa-envelope fa-lg text-grey form-control-feedback"></span>
			</div>
			<div class="form-group has-feedback">
			<input type="password" name="password" placeholder="{{ Lang::get('core.password') }}" class="form-control" required="true" />
				<span class="fa fa-unlock fa-lg text-grey form-control-feedback"></span>
			</div>
			...
			<div class="row">
				...
				<button type="submit" class="btn btn-success btn-block btn-flat">{{ Lang::get('core.signin') }}</button>
				</div>
				<!-- /.col -->
			</div>
			</form>
