...
?>
    ...
    <div class="box-header with-border">
        <div class="box-header-tools pull-left">
            ...
            @if($access['is_add'] ==1)
            <a href="{{ url('hotels/update/'.$id.'?return='.$return) }}" class="tips text-green" title="{{ Lang::get('core.btn_edit') }}"><i class="fa  fa-pencil fa-2x"></i></a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>@if($access['is_remove'] =='1')
                                    ...
                                    <a href="{{ url('hotelrates/update/'.$rr['hotelrateid'].'/?hotelID='.$id)}}" onclick="MmbModal(this.href,'{{ Lang::get('core.editroomrate') }}'); return false;" class="btn btn-default btn-xs btn-flat pull-right tips" title="{{ Lang::get('core.edit') }}"><i class="fa fa-pencil text-navy"></i></a> @endif
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>@if($access['is_remove'] =='1')
                                    ...
                                    <a href="{{ url('hotelsnote/update/'.$hn['hotel_noteID'].'/?hotelID='.$id)}}" onclick="MmbModal(this.href,'{{ Lang::get('core.editnote') }}'); return false;" class="btn btn-default btn-xs btn-flat pull-right tips" title="{{ Lang::get('core.edit') }}"><i class="fa fa-pencil text-navy"></i></a> @endif
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
