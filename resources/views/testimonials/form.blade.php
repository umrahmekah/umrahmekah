				...
				{!! Form::hidden('testimonialID', $row['testimonialID']) !!}					
						...
						required     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <select name='tour_name' rows='5' id='tour_name' class='select2 ' required  ></select> 
										 </div> 
										 <div class="col-md-2">
										 </div>
									  </div> 					
...
$(document).ready(function() { 
		...
		$("#tour_name").jCombo("{!! url('testimonials/comboselect?filter=tours:tourID:tour_name') !!}",
		{  selected_value : '{{ $row["tour_name"] }}' });
