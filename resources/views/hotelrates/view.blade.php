...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<div class="box-header-tools pull-left" >
			@if($access['is_add'] ==1)
	   		<a href="{{ url('hotelrates/update/'.$id.'?return='.$return) }}" class="tips btn btn-default btn-xs " title="{{ Lang::get('core.btn_edit') }}" onclick="ajaxViewDetail('#hotelrates',this.href); return false; "><i class="fa  fa-pencil fa-2x"></i></a>
			@endif 
