...
<script type="text/javascript" src="{{ asset('mmb/js/calendar/locale/id.js') }}"></script>
<script type="text/javascript" src="{{ asset('mmb/js/calendar/locale/ms.js') }}"></script>
...
$(document).ready(function() {
		...
		$('#calendar').fullCalendar({
			locale: '{{ Session::get('lang') == 'my' ? 'ms' : Session::get('lang') }}',
			header: {
				left: 'title',
				center: '',
			...
			select: function(start, end) {
				MmbModal('{{ url("calendartourdates/update/") }}','{{ Lang::get('core.addnewtour') }}');
			},
