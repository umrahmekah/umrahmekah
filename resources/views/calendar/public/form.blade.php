		 ...
		 {!! Form::open(array('url'=>'calendar/savepublic', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
						...
						<fieldset><legend> Calendar</legend>
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='start' id='start' value='{{ $row['start'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-2">
