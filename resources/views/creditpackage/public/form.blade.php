		 ...
		 {!! Form::open(array('url'=>'creditpackage/savepublic', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
						<fieldset><legend> Credit Package</legend>
						     ...
						     class='form-control input-sm ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='currency' id='currency' value='{{ $row['currency'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
										 <div class="col-md-2">
