...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'tourboundinclusion/save/'.SiteHelpers::encryptID($row['inclusionID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'tourboundinclusionFormAjax')) !!}
			<div class="col-md-12">
...
$(document).ready(function() { 
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("tourboundinclusion/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
