...
<div class="box box-primary ">
	<div class="box-body"> 	
			...
			<div class="col-md-6">
							...
							class='select2 '  required  ></select> 
								  ...
								  <div class="form-group  " >
                                    ...
                                    <label class="control-label"> {{ $row['username'] }}</label>
                                    @else
        ...
        <div class="form-group  " >
                ...
                <div class="form-group  " >
									...
									<div class="col-md-6">
									  <div class="btn btn-primary btn-file"><i class="fa fa-camera fa-lg"></i> {{ Lang::get('core.selectfile') }}
   ...
   <script type="text/javascript">
    ...
    container: 'body'
		...
		$("#group_id").jCombo("{{ url('core/users/comboselect?filter=tb_groups:group_id:name') }}",
		{  selected_value : '{{ $row["group_id"] }}' });

		console.log("{{ url('core/users/comboselect?filter=tb_groups:group_id:name') }}");
