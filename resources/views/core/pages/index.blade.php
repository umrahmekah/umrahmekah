            ...
            @foreach ($rowData as $row)
                <tr>
					...
					<td>
							...
							@endif
							@if($access['is_edit'] ==1)
							<a  href="{{ URL::to('core/pages/update/'.$row->pageID.'?return='.$return) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-pencil fa-2x"></i></a>
							@endif
