...
<button type="button" onclick="MmbModal('{{ url("core/forms/input/".$row->formID) }}','New Input')" class="btn  btn-warning btn-sm" ><i class="fa fa-list-ul fa-1x"></i> New Field </button> 
<button class="btn btn-primary btn-sm" type="submit"><i class="fa fa-save fa-1x"></i> Save Order List </button>
<button class="btn btn-info btn-sm" type="button" id="submitRbld"><i class="fa fa-repeat fa-1x"></i>  Generate Form  </button>
<br /><br />
