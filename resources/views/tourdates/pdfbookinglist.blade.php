...
<td align="left">{{ Lang::get('core.singleroom') }}:{{ $room_single}}<br>{{ Lang::get('core.doubleroom') }}:{{ $room_double}}<br>{{ Lang::get('core.tripleroom') }}:{{ $room_triple}}<br>{{ Lang::get('core.quadroom') }}:{{ $room_quad}}<br>{{ Lang::get('core.totalpassenger') }}:{{ $total}}</td>
</tr>
