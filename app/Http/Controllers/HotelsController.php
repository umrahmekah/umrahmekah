...
class HotelsController extends Controller
{
    ...
    public function getUpdate(Request $request, $id = null)
    {
        ...
        if ($row) {
            ...
            if ('' == $id) {
                ...
                return Redirect::to('hotels')->with('messagetext', \Lang::get('core.note_restric'))->with('msgstatus', 'error');
            }
        }
    ...
    public static function hotelFacilities($facilities = '')
    {
        $hotelFacilities = '';
        if ('' != $facilities) {
    ...
    public static function similarHotel($ho = '')
    {
        $hotel = '';
        if ('' != $ho) {
