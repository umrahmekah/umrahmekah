...
class MmbHelpers
{
    ...
    public static function tf_read($a)
    {
        return base64_decode($a);
    }

    public static function tf_write($a)
    {
    ...
    public static function showForm($module = null)
    {
    ...
    public static function sjForm($id)
    {
        $id = $id; ?>
        ...
        {
        notyMessage(data.message);$('.ajaxLoading').hide();$('#mmb-modal').modal('hide');
        } else {
